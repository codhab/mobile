...
module Entity
  class InterestsController < ApplicationController
    ...
    def new
      @interest = Core::Entity::InterestForm.where(entity_id: current_entity.id, allotment_id: 4).new

    end

    def create
      @interest = Core::Entity::InterestForm.where(entity_id: current_entity.id, allotment_id: 4).new(set_params)
